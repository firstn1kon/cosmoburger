...
import { MainPage, NotFoundPage, LoginPage, RegisterPage, ForgotPasswordPage, 
         ResetPasswordPage, ProfilePage, ProfileOrdersPage, FeedPage } from "../../pages";
...
import OrderWsDetails from "../order-ws-details/order-ws-details";
        ...
        <>
          ...
          <main>
            <Routes location={background || location}>
              ...
              <Route path="/feed/:orderId" element={<OrderWsDetails/>}/>
              ...
              <Route path="/profile/orders/:orderId" element={<OnlyAuth component={<OrderWsDetails/>}/>}/> 
            ...
            {background && (
              <Routes>
                ...
                <Route path="/feed/:orderId" 
                  element={<Modal title={'Детали заказа'} close={closeModal}><OrderWsDetails/></Modal>}/>
